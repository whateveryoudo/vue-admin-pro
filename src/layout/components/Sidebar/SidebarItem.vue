<template>
  <div v-if="!item.hidden">
    ...
    <template v-if="showOneChildMenu">
      <AppLink
        v-if="onlyOneMenu && onlyOneMenu.meta"
        :to="resolvePath(onlyOneMenu.path)"
      >
        <el-menu-item :index="resolvePath(onlyOneMenu.path)">
          <svg-icon
            v-if="onlyOneMenu.meta.icon"
            :iconClass="onlyOneMenu.meta.icon"
          ></svg-icon>
          <i
            v-if="onlyOneMenu.meta.elemIcon"
            :class="onlyOneMenu.meta.elemIcon"
          ></i>
