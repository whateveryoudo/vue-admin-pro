  ...
  <div class="todo-list-container">
      ...
      <ul class="todo-list-wrapper">
        ...
        >
          <div class="normal" v-show="!todo.isEdit">
            ...
            />
            <div class="label" @dblclick="handleEdit(index)">
              {{ todo.text }}
            </div>
          ...
          <div class="editing" v-show="todo.isEdit">
            ...
            <div class="btns-wrapper">
              <el-button size="small" @click="cancelEdit(index)"
                >取消</el-button
              >
              <el-button size="small" type="primary" @click="doneEdit(index)"
                >保存</el-button
              >
            </div>
          </div>
    ...
    <footer class="footer">
      ...
      <ul class="filter-wrapper">
        <li :class="{ selected: curType === 1 }" @click="handleFilter(1)">
          全部
        </li>
        <li :class="{ selected: curType === 2 }" @click="handleFilter(2)">
          进行中
        </li>
        <li :class="{ selected: curType === 3 }" @click="handleFilter(3)">
          已完成
        </li>
      </ul>
    </footer>
